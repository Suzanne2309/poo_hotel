...
class Reservation{
    ...
    public function __toString() {
        return " Réservation du " . $this->_reservationDate . " par " . $this->_client . " à " . $this->_room . ". La réservation est pour " . $this->_nbPeoples . " peronnes, du " . $this->_startDate . " au " . $this->_endDate . ".";
    }
}